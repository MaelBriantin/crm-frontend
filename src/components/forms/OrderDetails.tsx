...
export const OrderDetails: React.FC<OrderDetailsProps> = ({
  ...
  const { orderDetails, isOrderPaid, setIsOrderPaid, loadingOrderDetails } =
  ...
  const customerDetailsMap = [
    ...
    {
      label: "Téléphone",
      value: orderDetails?.customer.phone || "Non renseigné",
    },
  ...
  orderDetails &&
    ...
    orderDetailsMap.push({
      label: "Date de paiement différé",
  ...
  orderDetails &&
    ...
    orderDetailsMap.push({
      ...
      value: orderDetails?.paid_at,
    });

  return (
    <DetailsContainer $loading={loadingOrderDetails}>
      {loadingOrderDetails && <Loader transparent />}
      {!loadingOrderDetails && (
        <GlobalContainer>
          <Details>
            <InfoContainer>
