...
import {fetchAllOrders} from "../services/api/orders/fetchAllOrders.ts";
...
type createOrdersStore = {
    ...
    orderValidationForm: OrderValidationType;
    setOrderValidationForm: (orderValidationForm: OrderValidationType) => void;
};
...
export const useStoreOrders = create<createOrdersStore>((set) => ({
    ...
    orderValidationForm: {} as OrderValidationType,
    setOrderValidationForm: (orderValidationForm: OrderValidationType) =>
        set({orderValidationForm}),
}));
